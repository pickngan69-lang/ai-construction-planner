// TPSO (สนค. กระทรวงพาณิชย์) province codes for the construction-material-price
// API (index-api.tpso.go.th). Verified live against the API — TPSO uses the
// standard MOI province codes. Code 10 = "ส่วนกลาง" (กทม.+นนทบุรี+ปทุมธานี+
// สมุทรปราการ, ~5,500 brand-level items); each other province carries ~100-300
// surveyed items. Provinces with no data for a given month return [].
export const TPSO_PROVINCES = [
  { code: 10, name: 'ส่วนกลาง (กทม./ปริมณฑล)' },
