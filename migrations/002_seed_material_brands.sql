-- ============================================================================
-- Migration 002 — seed brand-level market prices (โมดูล ERP)
-- ราคาแบรนด์สำหรับ autocomplete ในเกรด "ราคาที่กำหนด" (custom)
-- สร้างอัตโนมัติจาก MATERIAL_BASE (src/services/mockData.js)
-- รันใน Supabase SQL Editor หลังรัน 001_init_erp.sql แล้ว · รันซ้ำได้ (กันซ้ำด้วย NOT EXISTS)
-- ============================================================================

insert into public.material_market_prices (material_name, current_price)
...
where not exists (
  select 1 from public.material_market_prices m
  where m.material_name = v.name
);
